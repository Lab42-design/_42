$(function () {
    ...
    function getPageName() {
        ...
        console.log("0____________ pathName : " + pathName)

        if (pathName.indexOf("/") != -1) {

            console.log("1____________ pathName : " + pathName)
            pageName = pathName.split("/").pop();
            console.log("1____________ pageName : " + pageName)
